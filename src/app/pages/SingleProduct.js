...
import { addItem, selectItems } from "../components/redux/slices/basketSlice";
...
const SingleProduct = () => {
  ...
  return (
    <>
      <div className="container mx-auto md:5/6 pt-5 pb-7 px-2 md:px-0">
        {/* Bread curb */}
        {loading ? (
              ...
              <div className="w-full md:w-1/2 md:pl-8 capitalize">
                ...
                <div className="flex flex-wrap mt-5">
                  {product?.colors.map((color) => (
                    <div
                      key={color}
                      className="border-gray-200 mr-2 border-2 rounded-full h-6 w-6 flex items-center justify-center"
                ...
                <div>
                  {checkItemExists(id) ? (
                    <button className="bg-[#bb8e1d] text-white py-2 px-14 rounded text-sm mt-5 block">
                      Already added
                    </button>
                  ) : (
                    <button
